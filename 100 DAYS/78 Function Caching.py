...
# NOTE :- FUNCTION CACHING IS USED WHEN THE INPUTS CAN BE SAME WHEN GIVEN , TO PREVENT THE RUNNING TIME HAPPENING FOR THE SAME THE VALUE AGAIN AND AGAIN, IT STORES THE VALUE GIVEN TO A PARTICULAR FUNCTION IN THE FORM OF CACHE MEMORY ALSO STORES THE OUTPUT FOR THE INOUT , THIS HELPS TO REDUCE THE COMPUTATION TIME
