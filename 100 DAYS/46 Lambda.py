...
# NOTE :- TO GIVE FUCNTION AS A PARAMETER WE HAVE TO ONL WRITE A NAME OF THE FUNCTION
print(func1(funcadd,10))


def func3(func4,a):
   return a * func4(a)

print(func3(lambda x : x*x,4))  # where lambda fucntion can be usefull , when we want to pass the function as the arguments