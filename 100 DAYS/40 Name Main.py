...
# NOTE :- THE __name__ VARIABLE HOLDS A VALUE __main__ THAT'S WHY WE USE THE IF CONDITION TO CHECK, IT TRUE AND RUN THE PROGRAMME . IF WE print(__name__) THEN WE WILL GET THE VALUE (__main__), BUT IF WE PRINT IN FILE ON WHICH WE HAVE import THIS FILE WITH THE IMPORT NAME WE WILL GET THE NAME OF THE FILE ,THAT WE HAVE IMPORT 
# example:-
# import main
                   #main file
# main.welcome()
