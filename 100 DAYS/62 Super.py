...
#         print("this is base class display_method")
        
#     def base_method(self):
#         print("this is the base_method ")


# class Derived(Base):
#     def display_method(self):
#         print("this is the derived class display method") 

#     def derived_method(self):
#         print("this is the derived_method")
#         # calling the derived method
#         self.display_method()
#         # calling the base method
#         super().display_method()
#         self.base_method()
        
# objectDer = Derived()
# objectDer.derived_method()
...
class Base:
    def __init__(self,name,age):
        print("base class consturctor called")
        self.name = name
        self.age = age 
        
    def base_Details(self):
        print(f"this is the base method :- \nName is {self.name} and age is {self.age}")
        
        
class Derived(Base):
    def __init__(self,name,age,salary):
        print("derived class consturctor called")
        # NOTE:- HERE CALLING BY SELF WILL NOT WORK
        super().__init__(name,age)
        self.salary = salary
    
    def derived_Details(self):
        print(f"this is the derived method :- \nName is {self.name}, age is {self.age} and salary is {self.salary}")
    

Shubham = Derived(salary=150,name="shubham",age=18) 

Shubham.base_Details()