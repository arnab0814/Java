''''is' vs '==' in Python'''
# NOTE :- "is" CHECKS THE IDENTITY , IF THE VALUE IS STORED IN THE SAME LOCATION THEN IT WILL RETURN TRUE ,ELSE FALSE
# NOTE:- "==" COMPARES THE VLAUE , IF THE VALUE IS SAME THEN IT WILL RETURN TRUE, ELSE FALSE
